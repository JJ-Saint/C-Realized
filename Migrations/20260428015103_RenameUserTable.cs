    ...
    public partial class RenameUserTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReserveUser", x => new { x.ReserveId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ReserveUser_Reserve_ReserveId",
                        column: x => x.ReserveId,
                        principalTable: "Reserve",
                        principalColumn: "ReserveId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReserveUser_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
